...
main(int argc, char* argv[])
{
  ...
  mpdProducerHelper.SetAttribute("ContentDirectory", StringValue("/home/wf/Videos"));
  ...
  fakeSegmentProducerHelper.SetPrefix("/myprefix");
  ...
  ndn::DASHPlayerTracer::InstallAll("dash-output-avc.txt");
  ndn::CsTracer::InstallAll("cs-trace-avc.txt", Seconds(1));
